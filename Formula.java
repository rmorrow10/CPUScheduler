...
public class Formula {
	...
	public double getTurnaroundTime(double exitTime, double arrivalTime) {
	...
	public double getWaitingTime(double turnaroundTime, double burstTime) {
	...
	public double getResponseTime(double firstCPUTime, double arrivalTime) {
		responseTime = firstCPUTime - arrivalTime;
		return responseTime;
	}
